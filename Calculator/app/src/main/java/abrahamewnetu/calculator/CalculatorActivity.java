package abrahamewnetu.calculator;
/**
 * Created by abrahamewnetu on 3/19/16.
 * Calculator
 */
        ...
        public void onClick(View v) {
            ...
            if(v instanceof Button){
                ...
                // Check for the equals sign. If pressed, then calculate our result
                    ...
                    try {
                        double calcResult = Calc.evaluate(textViewOutputScreen.getText().toString());
                ...
                // Check if two math operators pressed in a row. If so, show an error message using Toast
                        ...
                        Calc.isOperator(textViewOutputScreen.getText().charAt(textViewOutputScreen.getText().length() - 1)) &&
                        Calc.isOperator(buttonClicked.getText().charAt(0)))
                {
